 ...
 * @example
 * ```typescript
 * // Example model suggestion for code-reviewer agent
 * const codeReviewerSuggestion: ModelSuggestion = {
 *   simple: 'claude-3-5-haiku-20241022',    // Quick code style review
 *   medium: 'claude-sonnet-4-5-20250929',   // Standard code review
 *   complex: 'claude-opus-4-5-20251101'     // Security-critical review
 * };
 *
 * // Example model suggestion for architecture-agent
 * const architectSuggestion: ModelSuggestion = {
 *   simple: 'claude-sonnet-4-5-20250929',   // Simple component design
 *   medium: 'claude-opus-4-5-20251101',     // Microservices architecture
 *   complex: 'claude-opus-4-5-20251101'     // Enterprise system design
 * };
 *
 * // Selecting model based on task complexity
 * const taskComplexity: 'simple' | 'medium' | 'complex' = 'complex';
 * const selectedModel = codeReviewerSuggestion[taskComplexity];
 * console.log(selectedModel); // 'claude-opus-4-5-20251101'
 * ```
 */

...
export const ja: LocaleMessages = {
  ...
  'ccb.reminder.mistakes':
    '**MeMesh エラー防止** - 過去 ${days} 日間に ${count} 件のエラー：',
  'ccb.reminder.memories':
    '**MeMesh メモリー呼び出し** - ${count} 件の関連メモリーが見つかりました：',
  'ccb.reminder.preferences':
    '**MeMesh ユーザー設定** - 過去のやり取りから学習：',
  'ccb.reminder.operationWarning':
    '**MeMesh 警告** - 過去に同様のミスがありました：${content}',

  // Preference summary
  'ccb.preference.summary': '**MeMesh ユーザー設定学習**',
  ...
  'ccb.rule.verifyBeforeClaim':
    '⚠️ **MeMesh 検証機能** - 完了を主張する前に検証しましたか？テストを実行し、出力を確認してください。',
  'ccb.rule.verifyBeforeClaim.suggestion':
    'タスクの完了を主張する前に、テストを実行し、コードを実行するか、変更を検証してください。',
  'ccb.rule.scopeCreep':
    '⚠️ **MeMesh スコープチェック** - 変更がユーザーの要求を超えている可能性があります。予想より多くのファイルを変更しています。',
  ...
  'ccb.preference.violation':
    '**MeMesh 設定アラート** - この操作はあなたの設定と競合する可能性があります。続行する前に確認してください。',

  // Common UI messages
  'ccb.status.loading': '**MeMesh** - 読み込み中...',
  'ccb.status.success': '**MeMesh** - 操作が正常に完了しました。',
  'ccb.status.error': '**MeMesh** - エラーが発生しました：${message}',
  'ccb.status.warning': '**MeMesh** - 警告：${message}',

  // Knowledge graph messages
  'ccb.knowledge.saved': '**MeMesh ナレッジ** - メモリーが正常に保存されました。',
  'ccb.knowledge.retrieved':
    '**MeMesh ナレッジ** - ${count} 件の関連メモリーを取得しました。',
  'ccb.knowledge.notFound': '**MeMesh ナレッジ** - 関連メモリーが見つかりませんでした。',

  // Prevention hook messages
  'ccb.hook.blocked':
    '**MeMesh 防止機能** - 防止ルール違反のため操作がブロックされました。',
  'ccb.hook.warning':
    '**MeMesh 警告** - 潜在的な問題が検出されました。続行する前に確認してください。',
  'ccb.hook.confirmationRequired':
    '**MeMesh 確認** - この操作を続行するにはユーザーの確認が必要です。',
  'ccb.hook.patternExtracted':
    '**MeMesh 学習** - ミスから防止パターンを抽出しました。',
  'ccb.hook.extractionFailed':
    '**MeMesh エラー** - 防止パターンの抽出に失敗しました。',
};
